...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h2 class="header-line" style="color:white">Manage Reg Students</h2>
    </div>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                           ...
                                           <td class="center"> <img src="<?php echo '../images/'.$result->profile_image;?>" style="height:50px; weight:50px;" /></td>
...
<?php } else {?>
                                            ...
                                            <a href="reg-students.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to Approve this student?');""><button class="btn btn-primary"> Approve</button> 
                                            <?php } ?>
