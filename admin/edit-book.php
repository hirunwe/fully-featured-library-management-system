...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price,Quantity=:qty where id=:bookid";
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h2 class="header-line" style="color:white">Add Book</h2>
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="qty" value="<?php echo htmlentities($result->quantity);?>"   />
 </div>
 <?php }} ?>
