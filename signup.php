...
include_once('stdSignupForm.php');
error_reporting(0);
?>
<!DOCTYPE html>
  ...
  <!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h2 class="header-line" style="color:white">Student Signup</h2>
...
<div class="col-md-9 col-md-offset-1">
        ...
        <form action="signup.php" method="post" enctype="multipart/form-data"  onSubmit="return valid();">
...
<input type="text"  name="vercode" maxlength="5" autocomplete="off" required style="width: 150px; height: 25px;" />&nbsp;<img src="captcha.php">
          ...
          <div class="form-group">
          <button type="submit" name="student_signup" class="btn btn-primary btn-block">Register Now </button>
