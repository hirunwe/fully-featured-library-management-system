...
$tid_borrow=$_SESSION['teachid'];
$rsts=0;
$sqlB ="SELECT id,BookId from Ttblissuedbookdetails where TeacherID=:tid_borrow and RetrunStatus=:rsts";
$queryB = $dbh -> prepare($sqlB);
$queryB->bindParam(':tid_borrow',$tid_borrow,PDO::PARAM_STR);
...
$teacherid=strtoupper($_SESSION['teachid']);
$bookid=intval($_GET['bookid']);
$sql="INSERT INTO  Ttblissuedbookdetails(TeacherID,BookId) VALUES(:teacherid,:bookid)";
...
//update quntity starts
$qty=$_SESSION['Tbookquantity'];
//$bookid=intval($_GET['bookid']);
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="qty" value="<?php if($result->quantity>0){ $_SESSION['Tbookquantity']=($result->quantity)-1;echo htmlentities("Available");}else{echo htmlentities("Not Available");}?>"   />
 </div>
 <?php }} ?>
