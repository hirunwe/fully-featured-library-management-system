...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblteachers WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblteachers set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<div class="col-md-12">
<h2 class="header-line" style="color:white">Teacher Password Recovery</h2>
</div>
</div>
...
<input type="text" class="form-control1"  name="vercode" maxlength="5" autocomplete="off" required  style="height:25px;" />&nbsp;<img src="captcha.php">
 ...
 <button type="submit" name="change" class="btn btn-info">Change Password</button> | <a href="tech_login.php">Login</a>
</form>
 </div>
</div>
</div>
