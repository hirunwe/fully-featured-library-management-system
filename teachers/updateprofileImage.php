...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Online Library Management System | Teacher Update Image</title>
      ...
      <div class="col-4 offset-md-4 form-div">
        <form action="updateprofileImage.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <button type="submit" name="Teacher_save_profile" class="btn btn-primary btn-block">Update Profile Image</button>
          </div>
        </form>
      </div>
    </div>
